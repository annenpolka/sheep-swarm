...
| 現在の作業上の既定値 | 直近は上位0・親1・子最大2でlazyの三対照を比較する。過去のpacket/N8/16/32系列は保持し、増員は次の主軸にしない |
